...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=int,
        default=3,
        help="Creates a patch of size patch_size x patch_size for poisoning at bottom right corner of image",
    )
    parser.add_argument(
        "--deletion_size",
        type=int,
    ...
    parser.add_argument(
        ...
        type=int,
        default=-1,
        help="All layers are freezed except the last-k layers, -1 means unfreeze all layers",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--unlearn_lr", type=float, default=0.025, help="learning rate (default: 0.025)"
    )
    parser.add_argument(
        "--pretrain_lr",
        type=float,
    ...
    parser.add_argument(
        "--wd", type=float, default=0.0005, help="learning rate (default: 0.01)"
    )
