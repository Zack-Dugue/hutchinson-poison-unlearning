...
def parse_unpath(un_path, pre_args, un_args, args, headers):
    ...
    if pre_args['dataset_method'] == 'poisoning':
        ...
        print(f'Train Poison Acc: {forget_acc}, Test Poison Acc: {test_acc}, Train Clean Acc: {forget_clean_acc}, Test Clean Acc {test_clean_acc}')
...
if __name__ == '__main__':
    ...
    preargnamelist = ['dataset', 'model', 'dataset_method', 'forget_set_size', 'patch_size', 'pretrain_iters', 'pretrain_lr', 'extra']
